...
public partial class IrBuilder
{
    ...
    public override object? VisitCallExpr([NotNull] NovusParser.CallExprContext context)
    {
        ...
        if (genericFuncName != null && _genericFunctionTemplates.ContainsKey(genericFuncName))
        {
            ...
            // Set up generic params temporarily using save/restore pattern.
            // A child scope approach would be cleaner but requires SymbolTable changes.
            ...
            // Restore generic params (clear temporary registrations)
            _symbols.ClearGenericParameters();
    ...
    // NOTE: String formatting methods (VisitInterpolatedStringLiteral, HandleInterpolatedStringImpl,
    // EmitWriteStrLiteral, EmitFormatExpression, EmitWriteStr, EmitFormatInteger, EmitFormatBool,
    // EmitFormatString, EmitDropForTemporaryString, ParseInterpolatedString, InterpolationSegment)
    // have been moved to IrBuilder.StringFormatting.cs for better code organization.
