...
\begin{lstlisting}
from std::ffi::amiga_consts import MEMF_PUBLIC, MEMF_CHIP, MEMF_FAST, MEMF_ANY, MEMF_CLEAR
\end{lstlisting}
...
match Allocation::<u32>::new($FFFFFFFFu32, MEMF_FAST) {
...
fn use_large_struct() {
    ...
    let initial = LargeBuffer { data: [0u8; 4096] }
