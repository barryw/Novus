...
The \texttt{std::os::dos} module provides RAII wrappers for AmigaOS file operations.
...
\begin{lstlisting}
from std::os::dos import OwnedFileHandle
from std::ffi::amiga_consts import MODE_NEWFILE
...
fn read_lines_example() -> Result<(), DosError> {
    ...
    var line_buffer: [u8; 256] = [0u8; 256]
    var line_num: i32 = 1
...
\begin{lstlisting}
from std::os::dos import OwnedFileHandle
from std::ffi::amiga_consts import MODE_OLDFILE, OFFSET_BEGINNING, OFFSET_CURRENT, OFFSET_END
...
from std::ffi::amiga_consts import ACCESS_READ, ACCESS_WRITE
...
AmigaOS uses \texttt{ReadArgs()} for parsing command-line arguments with a template syntax. The \texttt{std::args} module provides a type-safe wrapper.
...
\begin{lstlisting}
from std::args import ArgParser, ArgType
...
\begin{lstlisting}
from std::args import is_workbench, Args, get_workbench_startup
...
\begin{lstlisting}
from std::args import get_workbench_startup, WorkbenchStartup
...
\begin{lstlisting}
from std::os::dos import OwnedFileHandle, DosError
...
\begin{lstlisting}
from std::os::dos import OwnedFileHandle, file_info
from std::memory::block import MemoryBlock
from std::ffi::amiga_consts import MODE_OLDFILE, MEMF_ANY, OFFSET_BEGINNING
...
\begin{lstlisting}
from std::os::dos import OwnedFileHandle, file_exists, delete_file
from std::ffi::amiga_consts import MODE_NEWFILE
