...
\begin{description}
    \item[Native Performance] Novus compiles directly to 68k assembly, then to Amiga executables via the VBCC toolchain. There is no interpreter, no virtual machine, no runtime overhead beyond what you explicitly request.
    ...
    \item[Readable Output] The generated assembly is clean and well-commented. When you need to understand what the compiler is doing—and on the Amiga, you often do—the output won't fight you.
