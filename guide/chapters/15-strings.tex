...
The \texttt{std::string} module provides a comprehensive string handling system designed for Amiga development. It offers both borrowed views (zero-copy) and owned strings (heap-allocated), plus AmigaDOS-specific types like BCPL strings.
...
\begin{lstlisting}
from std::string import String, Str
...
\begin{lstlisting}
from std::string import NameString, Str
...
\begin{lstlisting}
from std::string import GadgetString, Str
...
\begin{lstlisting}
from std::string import StringBuilder, Str
...
\begin{lstlisting}
from std::string import str_join, Str
...
The \texttt{std::string} module provides traits for formatted output:

\begin{lstlisting}
from std::string import Display, Debug, Formatter
...
\begin{lstlisting}
from std::string import StackFormatter
