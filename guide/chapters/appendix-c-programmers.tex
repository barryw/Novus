...
\texttt{\_Alignof(T)} & \texttt{alignof(T)} (in inline asm only) \\
...
The NDK bindings are organized by library in \texttt{amiga::raw}:

\begin{lstlisting}
// ... (FFI import examples - illustrative)
from amiga::raw::exec import AllocMem, FreeMem, FindTask, Wait, Signal
from amiga::raw::dos import Open, Close, Read, Write, IoErr, Lock, UnLock
from amiga::raw::graphics import BltBitMap, SetAPen, RectFill, Text
from amiga::raw::intuition import OpenWindow, CloseWindow, RefreshGList
from amiga::raw::gadtools import CreateMenus, FreeMenus, LayoutMenus
from amiga::raw::layers import CreateUpfrontLayer, DeleteLayer
from amiga::raw::utility import AllocateTagItems, FreeTagItems
\end{lstlisting}
...
from amiga::raw::structs import Window, Screen, BitMap
from amiga::raw::consts import MEMF_CHIP, MEMF_FAST, MEMF_CLEAR
\end{lstlisting}
...
from amiga::raw::consts import WA_Width, WA_Height, WA_Title,
