...
from amiga::raw::consts import MEMF_CHIP, MEMF_FAST, MEMF_TOTAL
...
\begin{description}
    ...
    \item[\texttt{std::string}] String handling: \texttt{String}, \texttt{Str}, \texttt{StringBuilder}
    ...
    \item[\texttt{amiga::raw}] AmigaOS bindings (Exec, DOS, Graphics, Intuition)
    \item[\texttt{amiga::sys::hardware}] CPU/chipset detection, memory info
\end{description}
...
from std::io::file import print, println
from amiga::raw::exec import AvailMem
from amiga::raw::consts import MEMF_FAST, MEMF_CHIP
from amiga::raw::consts import MEMF_TOTAL, MEMF_LARGEST

fn print_memory(label: *u8, bytes: u32) {
    print("  ")
    print(label)
    print(": ")
    let kb: u32 = bytes / 1024
    if kb == 0 {
        print("0")
    } else {
        print_number(kb)
