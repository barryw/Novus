...
let root = sqrt(16)   // Returns 4
let root2 = sqrt(100) // Returns 10
let root3 = sqrt(2)   // Returns 1 (integer truncation)
\end{lstlisting}
...
\begin{lstlisting}
from amiga::sys::hardware::cpu import get_cpu_type, has_fpu, CpuType
