...
fn unique_ids() -> Result<(), ExecError> {
    ...
    seen.insert(1u32)?  // Ok(true)
    seen.insert(2u32)?  // Ok(true)
    seen.insert(1u32)?  // Ok(false) - already present

    // Check membership
    if seen.contains(&1u32) {
        // value is in set
    }

    // Remove
    seen.remove(&2u32)  // returns true
